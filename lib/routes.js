...
Routes.prototype = {
	...
	listenChannel: function (req, res) {
	...
	addTrackToChannel: function (req, res) {
		var uid = req.params.uid;
	...
	searchTracks: function (req, res, next) {
	...
	onUnknownMethodRequest: function (req, res) {
	...
	onRequestExecuted: function (req, res) {
		if (res.methods &&
